...
- Status: Accepted (2026-07-30, PR #24, as amended - expansion tabled, E46-page-as-view); amended 2026-08-19 (§7, the mint registry); amended 2026-08-20 (§7, twin rulings resolve through a registry)
- Date: 2026-07-30
...
## Amendment (2026-08-20): §7 — twin rulings resolve through a registry
...
never as era-forked names. `WIKIDATA_TWIN_NAMEPLATES` records the per-
...
- `era:<company>/<slug>` — this entity is one era: it becomes a generation
  ...
  waits visibly at `twin_era_awaits_span`.
...
which is how concurrent-market twins (Kamiq China, Rapid China/India) and
